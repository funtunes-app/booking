...
var api = {
  ...
  addStaff: async function (staff) {
    var row = {
      ...
      fixed_pay: parseInt(staff.fixed_pay) || 0,
      pro_rata_base: parseInt(staff.pro_rata_base) || 0,
      hours_per_shift: parseInt(staff.hours_per_shift) || 4,
      paid_holidays: parseInt(staff.paid_holidays) || 4,
